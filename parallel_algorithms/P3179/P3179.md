...
- [18.2]{.pnum} `{last, result + @[_N_]{.rm}[_M_]{.add}@}` for the overloads in namespace
  `ranges`[, if `result_last - result >= @_M_@` is `true`]{.add}.
...
- [13.2]{.pnum} `{last, result + @[_N_]{.rm}[_M_]{.add}@}` for the overloads in namespace
  `ranges`[, if `result_last - result >= @_M_@` is `true`]{.add}.
...
- [10.2]{.pnum} `{last, result + @[_N_]{.rm}[_M_]{.add}@}` for the overloads in namespace
  `ranges`[, if `result_last - result >= @_M_@` is `true`]{.add}.
...
- [4.2]{.pnum} `{last1, last2, @[result_last]{.rm}[result + _K_]{.add}@}` for the overloads in namespace
  `ranges`[, if `result_last - result >= @_K_@` is `true`]{.add}.
...
- [4.1]{.pnum} `result_last` for the overloads in namespace `std`.
- [4.2]{.pnum} `{last1, @[result_last]{.rm}[result + _K_]{.add}@}` for the overloads in namespace
  `ranges`[, if `result_last - result >= @_K_@` is `true`]{.add}.
...
- [4.1]{.pnum} `result_last` for the overloads in namespace `std`.
- [4.2]{.pnum} ``{last1, last2, @@[result_last]{.rm}[`result + @_K_@ + @_M_@`]{.add}@@}`` for the overloads in
  namespace `ranges`[, if `result_last - result >= @_K_@ + @_M_@` is `true`]{.add}.
- [4.x]{.pnum} [Otherwise, `{j1, j2, result_last}` for the overloads in namespace `ranges`,
