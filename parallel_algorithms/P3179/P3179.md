...
- ~~Shorten the exec policy parameter + italicise the exposition only context~~
- LWG question: synopsis for memory
- LWG question: rules for using the ranges namespace in signatures
...
- Find the right place for the *execution-policy* concept; add some text into [Supported execution policies] and maybe mention it as a difference to C++17
- ? Mention "ranges" in [algorithms.parallel.defns]{- .sref}
