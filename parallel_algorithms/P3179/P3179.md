...
- Explain design choice for `rotate_copy`, `reverse_copy`, and `partition_copy`.
...
- TODO: Possible improve the wording for `partition_copy` and `merge`. DO NOT FORGET TO REMOVE THIS BULLET !!!!
