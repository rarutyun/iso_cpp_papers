...
The current description in [algorithms.parallel.defns]{- .sref} may need to be extended to cover views.
...
To better define the desired extensions, we should also analyse which view pipelines would be thread-safe
