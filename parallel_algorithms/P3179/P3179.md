...
- [x.2]{.pnum} *`K`* be `(last1 - first1)` plus the number of elements in `[first2, last2)` that are not present in `[first1, last1)`;
...
- [4.x]{.pnum} [`{last1, last2, result + @_K_@}` for the overloads in namespace `ranges`, if `result_last - result >= @_K_@` is `true`.]{.add}
- [4.2]{.pnum} [`{last1, last2, result_last}`]{.rm}[Otherwise, `{j1, j2, result_last}`]{.add} for the overloads in namespace `ranges`[,
...
- [4.1]{.pnum} `result_last` for the overloads in namespace `std`.
- [4.x]{.pnum} [`{last1, last2, result + @_K_@}` for the overloads in namespace `ranges`, if `result_last - result >= @_K_@` is `true`.]{.add}
- [4.2]{.pnum} [`{last1, last2, result_last}`]{.rm}[Otherwise, `{j1, j2, result_last}`]{.add} for the overloads in namespace
...
- [4.1]{.pnum} `result_last` for the overloads in namespace `std`.
- [4.x]{.pnum} [`{last1, result + @_K_@}` for the overloads in namespace `ranges`, if `result_last - result >= @_K_@` is `true`.]{.add}
- [4.2]{.pnum} [`{last1, result_last}`]{.rm}[Otherwise, `{j1, result_last}`]{.add} for the overloads in namespace `ranges`[,
...
- [4.1]{.pnum} `result_last` for the overloads in namespace `std`.
- [4.x]{.pnum} [`{last1, last2, result + @_K_@ + @_M_@}` for the overloads in namespace `ranges`, if `result_last - result >= @_K_@ + @_M_@` is `true`.]{.add}
- [4.2]{.pnum} [`{last1, last2, result_last}`]{.rm}[Otherwise, `{j1, j2, result_last}`]{.add} for the overloads in namespace `ranges`[,
