...
- [4.x]{.pnum} [`{last1, last2, result + @_N_@}`, if `result_last - result >= @_N_@` is `true`.]{.add}
- [4.2]{.pnum} [`{last1, last2, result_last}`]{.rm}[`{j1, j2, result + @_N_@}`]{.add} for the overloads in namespace `ranges`[,
  ...
  `[first2, last2)`, respectively, if `result + @_N_@ == result_last` is `true`]{.add}.
...
- [4.1]{.pnum} `result_last` for the overloads in namespace `std`.
- [4.x]{.pnum} [`{last1, last2, result + @_N_@}`, if `result_last - result >= @_N_@` is `true`.]{.add}
- [4.2]{.pnum} [`{last1, last2, result_last}`]{.rm}[`{j1, j2, result + @_N_@}`]{.add} for the overloads in namespace
  `ranges`[, where the iterators `j1` and `j2` point to positions past the last copied or skipped elements in
  `[first1, last1)` and `[first2, last2)`, respectively, if `result + @_N_@ == result_last` is `true`]{.add}.
...
- [4.1]{.pnum} `result_last` for the overloads in namespace `std`.
- [4.x]{.pnum} [`{last1, result + @_N_@}`, if `result_last - result >= @_N_@` is `true`.]{.add}
- [4.2]{.pnum} [`{last1, result_last}`]{.rm}[`{j1, result + @_N_@}`]{.add} for the overloads in namespace `ranges`[,
  ...
  `result + @_N_@ == result_last` is `true`]{.add}.
...
- [4.2]{.pnum} [`{last1, last2, result_last}`]{.rm}[`{j1, j2, result + @_N_@}`]{.add} for the overloads in namespace `ranges`[,
  ...
  and `[first2, last2)`, respectively, if `result + @_N_@ == result_last` is `true`]{.add}.
