...
`ExecutionPolicy`, *&Theta;*`(last - first)` applications of the corresponding predicate, and no more than twice as many
...
- [3.5]{.pnum} For the overloads with an `ExecutionPolicy`, *&Theta;*`(min(last1 - first1, last2 - first2))`
